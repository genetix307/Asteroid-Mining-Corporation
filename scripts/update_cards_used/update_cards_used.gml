...
// Critical Gold (ID 4)
if store.card_slot_1 == 4 or store.card_slot_2 == 4 or store.card_slot_3 == 4 or store.card_slot_4 == 4 or store.card_slot_5 == 4 {
    store.card_critical_gold_used += 1;
}

// Critical Heart (ID 5)
if store.card_slot_1 == 5 or store.card_slot_2 == 5 or store.card_slot_3 == 5 or store.card_slot_4 == 5 or store.card_slot_5 == 5 {
...
if store.card_slot_1 == 8 or store.card_slot_2 == 8 or store.card_slot_3 == 8 or store.card_slot_4 == 8 or store.card_slot_5 == 8 {
...
// Shield Gold (ID 14)
if store.card_slot_1 == 14 or store.card_slot_2 == 14 or store.card_slot_3 == 14 or store.card_slot_4 == 14 or store.card_slot_5 == 14 {
...
// Snipe Shot (ID 17)
if store.card_slot_1 == 17 or store.card_slot_2 == 17 or store.card_slot_3 == 17 or store.card_slot_4 == 17 or store.card_slot_5 == 17 {
