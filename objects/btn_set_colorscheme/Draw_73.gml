...
draw_text_color(x-80,y-24,myName,c_black,c_black,c_black,c_black,1)
draw_text_color(x-82,y-26,myName,c_white,c_white,c_silver,c_silver,1)
...
draw_set_font(font_stats_tiny)
draw_text_color(x-60,y-4,_color,c_black,c_black,c_black,c_black,1)
draw_text_color(x-62,y-6,_color,c_white,c_white,c_silver,c_silver,1)