...
instance_create_depth(620,380,depth-1,btn_lvl_upgrade).my_id=slot_1
instance_create_depth(620,490,depth-1,btn_lvl_upgrade).my_id=slot_2
instance_create_depth(620,600,depth-1,btn_lvl_upgrade).my_id=slot_3
